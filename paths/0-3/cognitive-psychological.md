...
description: 从依恋建立到符号思维萌芽的完整认知发展路径
estimated_duration: 0-24个月（持续进行）
review_status: draft
---
...
本路径覆盖 0-3 岁认知与心理发展的 8 个核心能力，从安全依恋的建立到符号思维的萌芽。路径设计遵循发展心理学的自然顺序：先建立安全感（依恋），再发展认知能力（因果、客体永久性、联合注意），最后发展社会认知（自我意识、共情）和抽象思维（符号思维）。

如果家长想知道这些能力如何共同支持孩子以后的学习，可以先读[学习与探索的地基](../../stages/家庭期（25-45岁）/育儿指导/0-3岁/认知与心理/learning-foundations-01.md)。它提供的是日常观察和互动入口，不是提前学科训练。
...
- **completion_criteria**:
  - 用户能描述安全型依恋的基本特征
  - 用户已建立稳定的回应性照料模式（识别信号→及时回应→一致性）
  - 用户能识别分离焦虑的发展意义并有应对策略
  - 用户了解照料者自身状态对依恋的影响
- **trigger**:
...
- **completion_criteria**:
  ...
  - 用户理解"我的！"不是自私，而是自我意识发展的标志
  - 用户了解自我意识情绪（尴尬、自豪、羞愧）的出现时间
- **trigger**:
  - condition: state-based
