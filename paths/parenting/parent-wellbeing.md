...
description: 从产前准备到持续自我照顾的父母心理健康路径（覆盖 0-14 岁，14 岁后转至 parent-adolescent 路径）
estimated_duration: 孕期到孩子 14 岁（持续进行）
review_status: draft
---
...
本路径覆盖父母（照料者）心理健康的 13 个关键领域，从产前心理准备到持续的自我照顾，主要面向 0-14 岁阶段。路径分为三个阶段：产前准备期（怀孕到分娩）、新生儿适应期（0-12个月）、持续养育期（1岁后）。每个阶段都有核心任务和可选支持模块。

> **14 岁后**：当孩子进入 14-18 岁阶段，请参考 [青春期父母指导路径](parent-adolescent.md)，该路径覆盖亲子沟通重建、叛逆应对、心理危机识别、升学压力和数字生活管理等青少年期特有议题。本路径中部分 Prompt（如育儿焦虑管理、比较与竞争心理、父母身心健康等）的 `age_range` 覆盖到 18 岁，在 14-18 岁阶段仍然适用。
