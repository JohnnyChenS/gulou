...
本路径覆盖 6-9 岁认知与心理发展的 5 个核心能力。此阶段的核心是学校适应——从家庭环境进入正式学校教育，需要发展友谊技能（社交适应）、口头表达能力（课堂参与）、创造性思维（学科学习）、学校学习习惯和金钱概念（生活技能）。路径设计遵循从“适应学校”到“在学校中发展”的顺序。
...
- **内容**: [学校学习习惯](../../stages/家庭期（25-45岁）/育儿指导/6-9岁/认知与心理/school-learning-habits-01.md)
- **prerequisites**: [独立阅读过渡](../../stages/家庭期（25-45岁）/育儿指导/6-9岁/认知与心理/independent-reading-01.md)
- **age_range**: 6-9y
- **completion_criteria**:
  - 用户能把“作业拖延”拆成任务理解、启动、环境、疲劳或情绪等具体问题
  - 用户已和孩子练习用自己的话复述任务，并指出一个具体卡点
  - 用户开始让孩子在完成后检查一条标准，而不是替孩子全程监督
- **trigger**:
  - condition: state-based
  - description: 孩子刚入学、作业总是无法开始，或用户报告“孩子只会写不会学”
  - agent_should: 先了解任务、作息和学习环境，从最小的启动步骤开始调整
